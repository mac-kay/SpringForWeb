...
public class PagesController {
	...
	public String showIndexPage(Model model) {
		List<Products> products = productservice.getProductsUsingService();
	...
	/*
	 * @RequestMapping("/check") public String check(Model model) {
	 * 
	 ...
	 * + File.separator + "me.jpg"); String newserverFile =
	 * serverFile.toString().replace("\\", "/"); System.out.println("ServerFile : "
	 * + newserverFile); model.addAttribute("img", newserverFile);
	 * 
	 * return "check"; }
	 */
	...
	public @ResponseBody String showApi() {
		...
		return productservice.getProductsUsingService() + "";

	}

	@RequestMapping(value = "/addproduct", method = RequestMethod.POST)
	public String addProduct(Model model, HttpServletRequest request, Products product,
		...
		if (!file.isEmpty()) {
			try {
				...
				File serverFile = new File(request.getContextPath() + File.separator + "WebContent/Resources/images/"
			...
			System.err.println("You failed to upload " + "myfile" + " because the file was empty.");
		}
